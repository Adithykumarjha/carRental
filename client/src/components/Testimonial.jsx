    ...
    const testimonials = [
        { 
           name: "Emma Rodriguez",
            ...
            image: "", 
             review: "I have rented cars from various companies, but the experience with carRental was exceptional!" 
            },
        { 
           name: "A.Karthik",
                    ...
                    <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:-translate-y-1 transition-all duration-500">
                        ...
                        <div className="flex items-center gap-1 mt-4">
                            {Array(5).fill(0).map((_, index) => (
                                <img key={index} src={asseets.star_icon} alt="star-icon" />
                            ))}
                        </div>
